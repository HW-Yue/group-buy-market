package com.yue.test.domain.tag;

import com.yue.domain.tag.service.TagService;
...
public class ITagServiceTest {
    ...
    public void test_get_tag_bitmap() {
        ...
        // 是否存在
        log.info("xiaofuge 存在，预期结果为 true，测试结果:{}", bitSet.get(redisService.getIndexFromUserId("xfg04")));
