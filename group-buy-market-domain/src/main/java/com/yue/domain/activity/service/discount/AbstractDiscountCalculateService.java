package com.yue.domain.activity.service.discount;
...
public abstract class AbstractDiscountCalculateService implements IDiscountCalculateService {
    ...
    public BigDecimal isBlowLimitPrice(BigDecimal originalPrice, BigDecimal limitPrice) {
        if (originalPrice.compareTo(limitPrice) < 0) {
